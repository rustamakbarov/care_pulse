    ...
    <div className="z-10 w-full overflow-hidden rounded-lg border border-dark-400 shadow-lg">
      <Table className="rounded-lg overflow-hidden !important">
        <TableHeader className="bg-[#0D0F10]">
          {table.getHeaderGroups().map((headerGroup) => (
            <TableRow
              key={headerGroup.id}
              className="border-b border-[#1A1D21] text-light-200 hover:bg-transparent !important"
            >
          ...
          {table.getRowModel().rows?.length ? (
            table.getRowModel().rows.map((row) => (
              <TableRow
                ...
                className="border-b border-[#1A1D21] text-light-200 !important"
              >
      ...
      <div className=" flex w-full items-center justify-between space-x-2 p-4">
        <Button
          ...
          className="border border-[#363A3D] cursor-pointer bg-[#1A1D21] text-white !important"
        >
          <Image
